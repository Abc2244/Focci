...
async def get_user_stats(user_id: str, period: str):
    try:
        # Simplificar temporalmente para diagnóstico
        return {
            ...
            "data": {
                ...
                "subject_distribution": [
                    {"name": "Matemáticas", "color": "#FF5733", "percentage": 30},
                    {"name": "Ciencias", "color": "#33FF57", "percentage": 40},
                    {"name": "Historia", "color": "#3357FF", "percentage": 30}
                ]
            }
        }
